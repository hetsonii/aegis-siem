# ---------------------------------------------------------------------------
# Raw log lake: normalized events, evidence bundles, and VPC Flow Logs.
# Write-once, retained, tamper-evident (versioned) - the forensic source of truth.
# ---------------------------------------------------------------------------
...
# Allow VPC Flow Logs delivery to the lake bucket.
